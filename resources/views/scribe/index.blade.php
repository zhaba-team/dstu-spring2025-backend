                                                ...
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#endpoints-GETapi-users-roles">
                                                    GET api/users/roles
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-endpoints-GETapi-emails-send-verify-code">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="GET api/emails/send-verify-code">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#endpoints-GETapi-emails-send-verify-code">
                                                    GET api/emails/send-verify-code
                                                </a>
                                            </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-endpoints-POSTapi-emails-verify-code">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="POST api/emails/verify-code">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#endpoints-POSTapi-emails-verify-code">
                                                    POST api/emails/verify-code
                                                </a>
                                            </div>
                                                                                    </div>
                                                                    ...
                                                                    <div class="expandable">
                                        <div class="sl-flex sl-items-center sl-h-md sl-pr-4 sl-pl-8 sl-bg-canvas-100 hover:sl-bg-canvas-200 sl-cursor-pointer sl-select-none"
                                             id="toc-item-endpoints-POSTapi-users--userId-">
                                            <div class="sl-flex-1 sl-items-center sl-truncate sl-mr-1.5 sl-p-0" title="POST api/users/{userId}">
                                                <a class="ElementsTableOfContentsItem sl-block sl-no-underline"
                                                   href="#endpoints-POSTapi-users--userId-">
        ...
        <path fill="currentColor"
              d="M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z"></path>
                                                ...
                                                <pre><code class="language-http">                                                            cache-control
                                                            ...
                                                            : *
                                                                                                                    set-cookie
                                                            : XSRF-TOKEN=%3D; expires=Sat, 29 Mar 2025 23:14:18 GMT; Max-Age=7200; path=/; samesite=lax; deniskorbakov_session=%3D; expires=Sat, 29 Mar 2025 23:14:18 GMT; Max-Age=7200; path=/; httponly; samesite=lax
                                                         </code></pre>
                                            </details>
...
response.json()</code></pre>                                        </div>
        ...
        <path fill="currentColor"
              d="M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z"></path>
                                                ...
                                                <pre><code class="language-http">                                                            cache-control
                                                            ...
                                                            : *
                                                                                                                    set-cookie
                                                            : XSRF-TOKEN=%3D; expires=Sat, 29 Mar 2025 23:14:18 GMT; Max-Age=7200; path=/; samesite=lax; deniskorbakov_session=%3D; expires=Sat, 29 Mar 2025 23:14:18 GMT; Max-Age=7200; path=/; httponly; samesite=lax
                                                         </code></pre>
                                            </details>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="endpoints-GETapi-emails-send-verify-code">
                    GET api/emails/send-verify-code
                </h2>
            </div>
        </div>
...
response.json()</code></pre>                                        </div>
        ...
        <path fill="currentColor"
              d="M96 480c-8.188 0-16.38-3.125-22.62-9.375c-12.5-12.5-12.5-32.75 0-45.25L242.8 256L73.38 86.63c-12.5-12.5-12.5-32.75 0-45.25s32.75-12.5 45.25 0l192 192c12.5 12.5 12.5 32.75 0 45.25l-192 192C112.4 476.9 104.2 480 96 480z"></path>
                                                ...
                                                <pre><code class="language-http">                                                            cache-control
                                                            ...
                                                            : *
                                                                                                                    set-cookie
                                                            : XSRF-TOKEN=%3D; expires=Sat, 29 Mar 2025 23:14:18 GMT; Max-Age=7200; path=/; samesite=lax; deniskorbakov_session=%3D; expires=Sat, 29 Mar 2025 23:14:18 GMT; Max-Age=7200; path=/; httponly; samesite=lax
                                                         </code></pre>
                                            </details>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="endpoints-POSTapi-emails-verify-code">
                    POST api/emails/verify-code
                </h2>
            </div>
        </div>
...
response.json()</code></pre>                                        </div>
    ...
    <div class="sl-stack sl-stack--vertical sl-stack--5 sl-flex sl-flex-col sl-items-stretch">
        <div class="sl-relative">
            <div class="sl-stack sl-stack--horizontal sl-stack--5 sl-flex sl-flex-row sl-items-center">
                <h2 class="sl-text-3xl sl-leading-tight sl-font-prose sl-text-heading sl-mt-5 sl-mb-1"
                    id="endpoints-POSTapi-users--userId-">
                    POST api/users/{userId}
                </h2>
            </div>
        </div>
                                            ...
                                            <div class="sl-mb-2 sl-inline-block">
                                                <select
                                                        ...
                                                        onchange="switchExampleResponse('POSTapi-register', event.target.value);">
                                                                                                            <option value="0">404, user not found z</option>
                                                                                                    </select></div>
                                        </div>
                                    </div>
                                </div>
